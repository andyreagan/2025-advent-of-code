...
pub fn process(input: &str, connections_to_make: usize) -> i32 {
    ...
    // keep going until fully connected
    ...
    connections_made -= 1;
    points[all_distances[connections_made].0][0] * points[all_distances[connections_made].1][0]
}
